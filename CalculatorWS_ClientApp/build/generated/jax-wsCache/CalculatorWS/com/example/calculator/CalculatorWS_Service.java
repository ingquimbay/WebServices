 ...
 * 
 */
@WebServiceClient(name = "CalculatorWS", targetNamespace = "http://calculator.example.com/", wsdlLocation = "http://localhost:8080/CalculatorWS/CalculatorWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWS_QNAME = new QName("http://calculator.example.com/", "CalculatorWS");
    ...
    public CalculatorWS getCalculatorWSPort() {
        return super.getPort(new QName("http://calculator.example.com/", "CalculatorWSPort"), CalculatorWS.class);
    }
    ...
    public CalculatorWS getCalculatorWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator.example.com/", "CalculatorWSPort"), CalculatorWS.class, features);
    }
